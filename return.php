...
session_start();
	...
	$a = $_SESSION['user'];
   $sql =<<<EOF
      SELECT  student.rollno,student.name,name_of_component,specification,quantity,date_of_receiving,expected_return_date,ta,type_of_component from student,issue where student.rollno = issue.rollno and student.rollno = '$a';
EOF;
 ...
 $ret = pg_query($db, $sql);
   ...
   echo "</table></html>";
   echo "<html><table>";
   /*echo " <tr><a href = 'action.php' > <input type = button name = Go_Back value = Go_Back></a></tr>";*/
   echo "<br>";
